...
const requestConfig = {
  ...
  secrets: { soundchartsAppId: process.env.SOUNDCHARTS_APP_ID, soundchartsApiKey: process.env.SOUNDCHARTS_API_KEY, songStatsAPIKey: process.env.SONGSTATS_API_KEY , chartmetricRefreshToken:process.env.CHARTMETRIC_REFRESH_TOKEN},
  // ETH wallet key used to sign secrets so they cannot be accessed by a 3rd party
  walletPrivateKey: process.env["PRIVATE_KEY"],
  // args (string only array) can be accessed within the source code with `args[index]` (ie: args[0]). 
  args: ["a59154fd-61aa-4076-9569-335dcc5e2b79", "sznmhxr8", "31456083"], // 0 = uuid for soundcharts - artist id , 1 = songstats artist id, 2 = chartmetric artist id
